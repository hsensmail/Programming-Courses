...
const hussein = new Person("Hussein", "Ismail", "JavaScript");
console.log(hussein);
console.log(hussein.__proto__);
console.log(hussein.__proto__.__proto__);
console.log(hussein.__proto__.__proto__.__proto__);
